...
Anti_PD_L1_B_tumor.metadata <- read.csv("GSE149652/Anti-PD-L1_A_tumor_CD4_droplet_cellinfo_matrice.csv")
...
saveRDS(Anti_PD_L1_B_tumor, file = "Anti_PD_L1_B_tumor_Normalized.rds")
Anti_PD_L1_B_tumor <- readRDS(file = "Anti_PD_L1_B_tumor_Normalized.rds")

Anti_PD_L1_B_tumor <- subset(Anti_PD_L1_B_tumor, subset = CD8A == 0)
Anti_PD_L1_B_tumor <- subset(Anti_PD_L1_B_tumor, subset = CD79A == 0)
Anti_PD_L1_B_tumor <- subset(Anti_PD_L1_B_tumor, subset = LYZ == 0)
Anti_PD_L1_B_tumor <- subset(Anti_PD_L1_B_tumor, subset = CST3 == 0)

Anti_PD_L1_B_tumor <- FindVariableFeatures(Anti_PD_L1_B_tumor, selection.method = "mean.var.plot", 
...
write.csv(VariableFeatures(Anti_PD_L1_B_tumor), "Anti_PD_L1_B_tumor_HVG.csv")

saveRDS(Anti_PD_L1_B_tumor, file = "Anti_PD_L1_B_tumor_HVG.rds")
Anti_PD_L1_B_tumor <- readRDS(file = "Anti_PD_L1_B_tumor_HVG.rds")

all.genes <- rownames(Anti_PD_L1_B_tumor)
Anti_PD_L1_B_tumor <- ScaleData(Anti_PD_L1_B_tumor, features = all.genes)
Anti_PD_L1_B_tumor <- RunPCA(Anti_PD_L1_B_tumor, npcs = 15)
DimPlot(Anti_PD_L1_B_tumor, reduction = "pca")
ElbowPlot(Anti_PD_L1_B_tumor, ndims = 15)

saveRDS(Anti_PD_L1_B_tumor, file = "Anti_PD_L1_B_tumor_PCA.rds")
Anti_PD_L1_B_tumor <- readRDS(file = "Anti_PD_L1_B_tumor_PCA.rds")

Anti_PD_L1_B_tumor <- RunTSNE(object = Anti_PD_L1_B_tumor, dims = 1:15)
TSNEPlot(object = Anti_PD_L1_B_tumor, label = TRUE, pt.size = 0.5)
FeaturePlot(Anti_PD_L1_B_tumor, features = "nCount_RNA")

Anti_PD_L1_B_tumor <- RunUMAP(object = Anti_PD_L1_B_tumor, dims = 1:15)
DimPlot(Anti_PD_L1_B_tumor, label = TRUE, pt.size = 0.5, reduction = "umap")

saveRDS(Anti_PD_L1_B_tumor, file = "Anti_PD_L1_B_tumor_TSNE_UMAP.rds")
Anti_PD_L1_B_tumor <- readRDS(file = "Anti_PD_L1_B_tumor_TSNE_UMAP.rds")

Anti_PD_L1_B_tumor <- FindNeighbors(Anti_PD_L1_B_tumor, dims = 1:15)
...
Idents(Anti_PD_L1_B_tumor) <- Anti_PD_L1_B_tumor$RNA_snn_res.0.9

Anti_PD_L1_B_tumor <- BuildClusterTree(object = Anti_PD_L1_B_tumor, dims = 1:15, reorder = TRUE, 
                                       reorder.numeric = TRUE)
PlotClusterTree(object = Anti_PD_L1_B_tumor)

Anti_PD_L1_B_tumor.markers <- FindAllMarkers(Anti_PD_L1_B_tumor)
m <- Anti_PD_L1_B_tumor.markers %>% group_by(cluster) %>% top_n(n = 10, wt = avg_logFC)
DoHeatmap(Anti_PD_L1_B_tumor, features = m$gene)
write.csv(Anti_PD_L1_B_tumor.markers, "Anti_PD_L1_B_tumor_all_markers_before_names.csv")

Anti_PD_L1_B_tumor.table_idents <- as.data.frame(table(Idents(Anti_PD_L1_B_tumor)))
write.csv(Anti_PD_L1_B_tumor.table_idents, "Anti_PD_L1_B_tumor_table_idents_before_names.csv")

TSNEPlot(object = Anti_PD_L1_B_tumor, label = TRUE, pt.size = 0.5)

Anti_PD_L1_B_tumor <- RenameIdents(Anti_PD_L1_B_tumor, "2" = "Cytotoxic CD4", "3" = "Tregs",
                                   "6" = "Cytotoxic CD4", "4" = "TCM", "5" = "TEM", "1" = "Cytotoxic CD4")

Anti_PD_L1_B_tumor <- BuildClusterTree(object = Anti_PD_L1_B_tumor, dims = 1:15, reorder = TRUE)
PlotClusterTree(object = Anti_PD_L1_B_tumor)

Anti_PD_L1_B_tumor$my_clusters <- Anti_PD_L1_B_tumor@active.ident

Anti_PD_L1_B_tumor.markers <- FindAllMarkers(Anti_PD_L1_B_tumor)
write.csv(Anti_PD_L1_B_tumor.markers, "Anti_PD_L1_B_tumor_all_markers_names.csv")

saveRDS(Anti_PD_L1_B_tumor, "Anti_PD_L1_B_tumor_clustered_names.rds")
Anti_PD_L1_B_tumor <- readRDS(file = "Anti_PD_L1_B_tumor_clustered_names.rds")

Anti_PD_L1_B_tumor_cytotoxic <- subset(Anti_PD_L1_B_tumor, subset = my_clusters == "Cytotoxic CD4")

saveRDS(Anti_PD_L1_B_tumor_cytotoxic, "Anti_PD_L1_B_tumor_cytotoxic.rds")
Anti_PD_L1_B_tumor_cytotoxic <- readRDS(file = "Anti_PD_L1_B_tumor_cytotoxic.rds")


Anti_PD_L1_B_tumor_heatmap <- clustify(Anti_PD_L1_B_tumor, cbmc_ref, cluster_col = "RNA_snn_res.0.7", obj_out = FALSE)
