...
Anti_PD_L1_C_tumor.metadata <- read.csv("GSE149652/Anti-PD-L1_A_tumor_CD4_droplet_cellinfo_matrice.csv")
...
saveRDS(Anti_PD_L1_C_tumor, file = "Anti_PD_L1_C_tumor_Normalized.rds")
Anti_PD_L1_C_tumor <- readRDS(file = "Anti_PD_L1_C_tumor_Normalized.rds")

Anti_PD_L1_C_tumor <- subset(Anti_PD_L1_C_tumor, subset = CD8A == 0)
Anti_PD_L1_C_tumor <- subset(Anti_PD_L1_C_tumor, subset = CD79A == 0)
Anti_PD_L1_C_tumor <- subset(Anti_PD_L1_C_tumor, subset = LYZ == 0)
Anti_PD_L1_C_tumor <- subset(Anti_PD_L1_C_tumor, subset = CST3 == 0)

Anti_PD_L1_C_tumor <- FindVariableFeatures(Anti_PD_L1_C_tumor, selection.method = "mean.var.plot", 
...
write.csv(VariableFeatures(Anti_PD_L1_C_tumor), "Anti_PD_L1_C_tumor_HVG.csv")

saveRDS(Anti_PD_L1_C_tumor, file = "Anti_PD_L1_C_tumor_HVG.rds")
Anti_PD_L1_C_tumor <- readRDS(file = "Anti_PD_L1_C_tumor_HVG.rds")

all.genes <- rownames(Anti_PD_L1_C_tumor)
Anti_PD_L1_C_tumor <- ScaleData(Anti_PD_L1_C_tumor, features = all.genes)
Anti_PD_L1_C_tumor <- RunPCA(Anti_PD_L1_C_tumor, npcs = 15)
DimPlot(Anti_PD_L1_C_tumor, reduction = "pca")
ElbowPlot(Anti_PD_L1_C_tumor, ndims = 15)

saveRDS(Anti_PD_L1_C_tumor, file = "Anti_PD_L1_C_tumor_PCA.rds")
Anti_PD_L1_C_tumor <- readRDS(file = "Anti_PD_L1_C_tumor_PCA.rds")

Anti_PD_L1_C_tumor <- RunTSNE(object = Anti_PD_L1_C_tumor, dims = 1:15)
TSNEPlot(object = Anti_PD_L1_C_tumor, label = TRUE, pt.size = 0.5)
FeaturePlot(Anti_PD_L1_C_tumor, features = "nCount_RNA")

Anti_PD_L1_C_tumor <- RunUMAP(object = Anti_PD_L1_C_tumor, dims = 1:15)
DimPlot(Anti_PD_L1_C_tumor, label = TRUE, pt.size = 0.5, reduction = "umap")

saveRDS(Anti_PD_L1_C_tumor, file = "Anti_PD_L1_C_tumor_TSNE_UMAP.rds")
Anti_PD_L1_C_tumor <- readRDS(file = "Anti_PD_L1_C_tumor_TSNE_UMAP.rds")

Anti_PD_L1_C_tumor <- FindNeighbors(Anti_PD_L1_C_tumor, dims = 1:15)
...
Anti_PD_L1_C_tumor <- BuildClusterTree(object = Anti_PD_L1_C_tumor, dims = 1:15, reorder = TRUE, 
                                       reorder.numeric = TRUE)
PlotClusterTree(object = Anti_PD_L1_C_tumor)

Anti_PD_L1_C_tumor.markers <- FindAllMarkers(Anti_PD_L1_C_tumor)
m <- Anti_PD_L1_C_tumor.markers %>% group_by(cluster) %>% top_n(n = 10, wt = avg_logFC)
DoHeatmap(Anti_PD_L1_C_tumor, features = m$gene)
write.csv(Anti_PD_L1_C_tumor.markers, "Anti_PD_L1_C_tumor_all_markers_before_names.csv")

Anti_PD_L1_C_tumor.table_idents <- as.data.frame(table(Idents(Anti_PD_L1_C_tumor)))
write.csv(Anti_PD_L1_C_tumor.table_idents, "Anti_PD_L1_C_tumor_table_idents_before_names.csv")

TSNEPlot(object = Anti_PD_L1_C_tumor, label = TRUE, pt.size = 0.5)

Anti_PD_L1_C_tumor <- RenameIdents(Anti_PD_L1_C_tumor, "1" = "Cytotoxic CD4", "3" = "Tregs", "2" = "Cytotoxic CD4", 
                                   "4" = "TCM", "5" = "TEM")

Anti_PD_L1_C_tumor <- BuildClusterTree(object = Anti_PD_L1_C_tumor, dims = 1:15, reorder = TRUE)
PlotClusterTree(object = Anti_PD_L1_C_tumor)

Anti_PD_L1_C_tumor$my_clusters <- Anti_PD_L1_C_tumor@active.ident

Anti_PD_L1_C_tumor.markers <- FindAllMarkers(Anti_PD_L1_C_tumor)
write.csv(Anti_PD_L1_C_tumor.markers, "Anti_PD_L1_C_tumor_all_markers_names.csv")

saveRDS(Anti_PD_L1_C_tumor, "Anti_PD_L1_C_tumor_clustered_names.rds")
Anti_PD_L1_C_tumor <- readRDS(file = "Anti_PD_L1_C_tumor_clustered_names.rds")

Anti_PD_L1_C_tumor_cytotoxic <- subset(Anti_PD_L1_C_tumor, subset = my_clusters == "Cytotoxic CD4")

saveRDS(Anti_PD_L1_C_tumor_cytotoxic, "Anti_PD_L1_C_tumor_cytotoxic.rds")
Anti_PD_L1_C_tumor_cytotoxic <- readRDS(file = "Anti_PD_L1_C_tumor_cytotoxic.rds")


Anti_PD_L1_C_tumor_heatmap <- clustify(Anti_PD_L1_C_tumor, cbmc_ref, cluster_col = "RNA_snn_res.0.7", obj_out = FALSE)
